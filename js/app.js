...
(function () {
    ...
    $form.addEventListener('submit', (e) => {
        ...
        if (nombre.trim() === '' || asunto.trim() === '' || mensaje.trim() === '' || !validarEmail) {
            ...
            fetch("https://formsubmit.co/ajax/estebanbraianrey@gmail.com", {
                method: "POST",
...
gsap.from('.proyecto1', {scrollTrigger: {trigger: '.proyecto1',},x: "-=500px", autoAlpha: 0, duration: 1, delay: 0.5})
gsap.from('.proyecto2', {scrollTrigger: {trigger: '.proyecto2',},x: "+=500px",autoAlpha: 0,duration: 1,delay: 0.5})
gsap.from('.proyecto3', {scrollTrigger: {trigger: '.proyecto3',}, x: "-=500px", autoAlpha: 0, duration: 1, delay: 0.5})
gsap.from('.tecnologias', {scrollTrigger: {trigger: '.tecnologias', }, x: "-=500px", autoAlpha: 0, duration: 1.5, delay: 0.5 })
gsap.from('.blandas', {scrollTrigger: {trigger: '.blandas',},x: "+=500px",autoAlpha: 0,duration: 1.5,delay: 0.5})
gsap.from('.sobre-mi_img', {scrollTrigger: {trigger: '.sobre-mi_img',},x: "-=500px",autoAlpha: 0,duration: 1.5,delay: 0.5})
gsap.from('.sobre-mi_descripcion', {scrollTrigger: {trigger: '.sobre-mi_descripcion',},x: "+=500px",autoAlpha: 0,duration: 1.5,delay: 0.5})
